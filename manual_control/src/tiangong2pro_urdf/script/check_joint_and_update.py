...
if __name__ == "__main__":
    urdf_file = "/home/zck/workspace/robot_manual_control/manual_control/src/tiangong2pro_urdf/urdf/tiangong2.0_complete_with_hands.xacro"
    csv_file = "/home/zck/workspace/robot_manual_control/manual_control/src/tiangong2pro_urdf/关键参数/URDF关键参数表 - 天工2.0pro.csv"
